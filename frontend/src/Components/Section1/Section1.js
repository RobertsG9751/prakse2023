    ...
    return(
        <div className={style.box}>
            ...
            <div className={style.blocks}>
                <Block btn_text={"Servers"}text={"Play your favorite CS:GO gamemodes on our servers."} header={"Play Games"} img={"https://cdn.akamai.steamstatic.com/steam/apps/730/ss_d196d945c6170e9cadaf67a6dea675bd5fa7a046.1920x1080.jpg?t=1668125812"}/>
